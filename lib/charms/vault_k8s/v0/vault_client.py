...
import requests
from hvac.exceptions import InvalidRequest, VaultError  # type: ignore[import-untyped]
...
@dataclass
class Certificate:
    """This class represents a certificate generated by the PKI secrets engine."""
