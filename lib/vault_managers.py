...
from charms.certificate_transfer_interface.v0.certificate_transfer import (  # type: ignore[import]
    CertificateTransferProvides,
)
from charms.data_platform_libs.v0.s3 import S3Requirer  # type: ignore[import]
from charms.tls_certificates_interface.v4.tls_certificates import (  # type: ignore[import]
    Certificate,
...
from charms.vault_k8s.v0.vault_kv import VaultKvProvides  # type: ignore[import]
...
class RaftManager:
    ...
    def _push_peers_json(self, node_id: str, address: str) -> None:
        ...
        pass
        self._workload.push(
            f"{self._storage_path}/raft/peers.json",
            self._get_peers_json(node_id, address),
        )
