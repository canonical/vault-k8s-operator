# Upgrade from 1.16 to 1.18

This guide covers the upgrade path from Vault charm 1.16 to 1.18. For general upgrade instructions, see the [upgrade guide](upgrade.md).
...
```shell
juju refresh vault --channel=1.18/stable --base ubuntu@24.04
```
