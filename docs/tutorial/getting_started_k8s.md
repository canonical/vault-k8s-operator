...
```shell
juju deploy vault-k8s vault --channel=1.19/edge --trust
```
...
vault           blocked      1  vault-k8s  1.19/edge  380  10.152.183.183  no       Please initialize Vault or integrate with an auto-unseal provider
