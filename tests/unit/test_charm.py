...
class TestCharm(unittest.TestCase):
    ...
    @patch("charms.vault_k8s.v0.vault.Vault.enable_audit_device", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.is_active", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.audit_device_enabled", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.unseal", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.is_sealed", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.is_initialized", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.is_api_available", new=Mock)
    @patch("ops.model.Container.push", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.is_raft_cluster_healthy", new=Mock)
    ...
    @patch("charms.vault_k8s.v0.vault.Vault.is_initialized", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.is_api_available")
    @patch("charm.generate_vault_unit_certificate")
    @patch("charm.generate_vault_ca_certificate")
    @patch("ops.model.Model.get_binding")
    ...
    @patch("charms.vault_k8s.v0.vault.Vault.is_sealed", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.is_raft_cluster_healthy", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.initialize")
    @patch("charms.vault_k8s.v0.vault.Vault.is_initialized")
    @patch("charms.vault_k8s.v0.vault.Vault.is_api_available")
    @patch("charm.generate_vault_unit_certificate")
    @patch("charm.generate_vault_ca_certificate")
    @patch("ops.model.Model.get_binding")
    ...
    @patch("charms.vault_k8s.v0.vault.Vault.is_sealed", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.is_raft_cluster_healthy", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.enable_audit_device")
    @patch("charms.vault_k8s.v0.vault.Vault.is_active")
    @patch("charms.vault_k8s.v0.vault.Vault.audit_device_enabled")
    @patch("charms.vault_k8s.v0.vault.Vault.initialize")
    @patch("charms.vault_k8s.v0.vault.Vault.is_initialized")
    @patch("charms.vault_k8s.v0.vault.Vault.is_api_available")
    @patch("charm.generate_vault_unit_certificate")
    ...
    @patch("ops.model.Model.get_binding")
    @patch("charms.vault_k8s.v0.vault.Vault.get_num_raft_peers")
    @patch("charms.vault_k8s.v0.vault.Vault.is_api_available")
    @patch("charms.vault_k8s.v0.vault.Vault.is_node_in_raft_peers")
    @patch("charms.vault_k8s.v0.vault.Vault.remove_raft_node")
    ...
    @patch("charms.vault_k8s.v0.vault.Vault.is_api_available")
    @patch("charms.vault_k8s.v0.vault.Vault.is_node_in_raft_peers")
    @patch("charms.vault_k8s.v0.vault.Vault.remove_raft_node", new=Mock)
    ...
    @patch("charms.vault_k8s.v0.vault.Vault.is_sealed", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.unseal", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.create_snapshot", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.is_initialized")
    @patch("charms.vault_k8s.v0.vault.Vault.is_api_available")
    @patch(f"{S3_LIB_PATH}.S3Requirer.get_s3_connection_info")
    @patch("s3_session.S3.create_bucket")
    ...
    @patch("charms.vault_k8s.v0.vault.Vault.is_initialized")
    @patch("charms.vault_k8s.v0.vault.Vault.is_api_available")
    @patch("charms.vault_k8s.v0.vault.Vault.restore_snapshot")
    @patch(f"{S3_LIB_PATH}.S3Requirer.get_s3_connection_info")
    ...
    @patch("charms.vault_k8s.v0.vault.Vault.is_sealed", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.unseal")
    @patch("s3_session.S3.get_content")
    @patch("charms.vault_k8s.v0.vault.Vault.is_initialized")
    @patch("charms.vault_k8s.v0.vault.Vault.is_api_available")
    @patch("charms.vault_k8s.v0.vault.Vault.restore_snapshot")
    ...
    @patch("charms.vault_k8s.v0.vault.Vault.is_sealed", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.unseal")
    @patch("charms.vault_k8s.v0.vault.Vault.set_token")
    @patch("s3_session.S3.get_content")
    @patch("charms.vault_k8s.v0.vault.Vault.is_initialized")
    @patch("charms.vault_k8s.v0.vault.Vault.is_api_available")
    @patch("charms.vault_k8s.v0.vault.Vault.restore_snapshot")
    ...
    @patch("charms.vault_k8s.v0.vault.Vault.is_api_available", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.is_sealed", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.set_token", new=Mock)
    ...
    @patch("charms.vault_k8s.v0.vault.Vault.is_api_available", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.set_token", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.configure_kv_mount", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.configure_kv_policy", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.generate_role_secret_id")
    @patch("charms.vault_k8s.v0.vault.Vault.configure_approle")
    @patch("charms.vault_k8s.v0.vault.Vault.enable_approle_auth")
    @patch("ops.model.Model.get_binding")
    ...
    @patch("charms.vault_k8s.v0.vault.Vault.is_api_available", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.set_token", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.enable_approle_auth", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.configure_kv_mount", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.configure_kv_policy", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.generate_role_secret_id")
    @patch("charms.vault_k8s.v0.vault.Vault.configure_approle")
    ...
    @patch("charms.vault_k8s.v0.vault.Vault.configure_kv_policy", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.is_initialized", new=Mock)
    @patch("charms.vault_k8s.v0.vault.Vault.read_role_secret")
    @patch("charms.vault_k8s.v0.vault.Vault.generate_role_secret_id")
    @patch("charms.vault_k8s.v0.vault.Vault.configure_approle")
    ...
    @patch("charms.vault_k8s.v0.vault.Vault.generate_role_secret_id")
    @patch("charms.vault_k8s.v0.vault.Vault.configure_approle")
    @patch("charms.vault_k8s.v0.vault.Vault.configure_kv_mount")
    @patch("ops.model.Model.get_binding")
