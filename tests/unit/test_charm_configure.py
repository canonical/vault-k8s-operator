...
class TestCharmConfigure(VaultCharmFixtures):
    ...
    def test_given_kv_request_when_configure_then_generate_kv_for_requirer_is_called(
        self,
    ):
        with tempfile.TemporaryDirectory() as temp_dir:
            self.mock_vault.configure_mock(
            ...
            kwargs = self.mock_kv_manager.generate_kv_for_requirer.call_args_list[0].kwargs
