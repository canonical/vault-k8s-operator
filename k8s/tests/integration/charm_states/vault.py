...
@pytest.fixture(scope="function")
async def vault_initialized(ops_test: OpsTest, vault_blocked: Task) -> Task[Tuple[str, str]]:
    """Deploy the Vault charm, and wait for it to be initialized.

    Returns:
        A tuple containing the root token, and the recovery
        or unseal key.
    """
